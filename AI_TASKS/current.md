...
- Issue：待填写。
- PR：[https://github.com/qixin-portfolio/geo-monitor-saas/pull/7](https://github.com/qixin-portfolio/geo-monitor-saas/pull/7)
- 分支：`codex/evidence-chain-hardening`
...
- [x] `pnpm test:unit` 通过，14 files / 45 tests。
- [x] `pnpm typecheck` 通过。
- [x] `pnpm build` 通过。
- [x] `git diff --check` 通过。
- [x] 不修改 Prisma schema。
